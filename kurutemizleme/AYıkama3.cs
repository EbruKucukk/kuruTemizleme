...
{
    public partial class AYıkama3 : Form
    {
        public AYıkama3()
        {
            InitializeComponent();
        ...
        private void AYıkama3_Load(object sender, EventArgs e)
        {
            ...
            while (Sdr.Read())
            {
                ...
                {
                    alınanMakine3.Items.Add(Sdr.GetString(i));
                }
            }
            Sdr.Close();
            con.Close();
            string alınmasaati = alınanSaat3.Text;
            String alımtarihi = alınmaTarihi3.Text;
            ...
            A3dataGridView.DataSource = DS2.Tables[0];
            A3dataGridView.AllowUserToAddRows = false;
            con.Close();
        }
        int count;
        int count2;
        ...
        private void islemButonu3_Click(object sender, EventArgs e)
        {
            if (secimTC3.Text != "")
            {
                ...
                if (DS.Tables[0].Rows.Count != 0)
                {
                    ...
                    secimAdSoyad3.Text = DS.Tables[0].Rows[0][4].ToString();
                    /* if (DS3.Tables[0].Rows.Count == 0)*/
                    if (count2 <= 0)
                    {
                        string alınmasaati = alınanSaat3.Text;
                        string alınanmakine = alınanMakine3.Text;
                        String alınmatarihi = alınmaTarihi3.Text;
                        ...
                        if (alınanMakine3.SelectedIndex != -1 && count <= 0)
                        {
                            String tc2 = secimTC3.Text;
                            String adsoyad2 = secimAdSoyad3.Text;
